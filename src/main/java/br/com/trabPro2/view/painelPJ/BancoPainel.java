...
public class BancoPainel extends JPanel {
    ...
    public BancoPainel(JFrame jframe) {
        ...
        tab.addTab("Cadastro", painelCadastro());package br.com.trabPro2.view.painelPJ;
...
public class BancoPainel extends JPanel {
    ...
    private JPanel painelCadastro() {
        ...
        label = new JLabel("Cadastrar Banco");
        ...
        butao.addActionListener(e -> {
            try {
                ...
                banco.setNome(ControllerPainel.getValuePainelName(form,"Nome"));
                banco.setCnpj(ControllerPainel.getValuePainelName(form,"CNPJ"));

                ControllerDB.addDB(banco);
